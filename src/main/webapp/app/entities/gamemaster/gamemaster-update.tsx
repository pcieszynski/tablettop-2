    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tabletTopApp.gamemaster.home.createOrEditLabel">Create or edit a Gamemaster</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : gamemasterEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="gamemaster-player" type="select" className="form-control" name="player.id">
                    <option value="" key="0" />
                    {players
