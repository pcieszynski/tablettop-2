    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tabletTopApp.playerMessage.home.createOrEditLabel">Create or edit a PlayerMessage</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : playerMessageEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="player-message-player" type="select" className="form-control" name="player.id">
                    <option value="" key="0" />
                    {players
                ...
                <AvGroup>
                  ...
                  <AvInput id="player-message-event" type="select" className="form-control" name="event.id">
                    <option value="" key="0" />
                    {events
