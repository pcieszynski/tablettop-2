            ...
            <tbody>
              {playerMessageList.map((playerMessage, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{playerMessage.player ? <Link to={`player/${playerMessage.player.id}`}>{playerMessage.player.id}</Link> : ''}</td>
                  <td>{playerMessage.event ? <Link to={`event/${playerMessage.event.id}`}>{playerMessage.event.id}</Link> : ''}</td>
