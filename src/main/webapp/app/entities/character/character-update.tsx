    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tabletTopApp.character.home.createOrEditLabel">Create or edit a Character</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : characterEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="character-helmet" type="select" className="form-control" name="helmet.id">
                    <option value="" key="0" />
                    {helmets
                ...
                <AvGroup>
                  ...
                  <AvInput id="character-armour" type="select" className="form-control" name="armour.id">
                    <option value="" key="0" />
                    {armours
                ...
                <AvGroup>
                  ...
                  <AvInput id="character-boots" type="select" className="form-control" name="boots.id">
                    <option value="" key="0" />
                    {boots
                ...
                <AvGroup>
                  ...
                  <AvInput id="character-gloves" type="select" className="form-control" name="gloves.id">
                    <option value="" key="0" />
                    {gloves
                ...
                <AvGroup>
                  ...
                  <AvInput id="character-legs" type="select" className="form-control" name="legs.id">
                    <option value="" key="0" />
                    {legs
                ...
                <AvGroup>
                  ...
                  <AvInput id="character-rightHand" type="select" className="form-control" name="rightHand.id">
                    <option value="" key="0" />
                    {rightHands
                ...
                <AvGroup>
                  ...
                  <AvInput id="character-leftHand" type="select" className="form-control" name="leftHand.id">
                    <option value="" key="0" />
                    {leftHands
