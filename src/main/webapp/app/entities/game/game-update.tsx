    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tabletTopApp.game.home.createOrEditLabel">Create or edit a Game</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : gameEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="game-gamemaster" type="select" className="form-control" name="gamemaster.id">
                    <option value="" key="0" />
                    {gamemasters
