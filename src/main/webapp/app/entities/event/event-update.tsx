    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tabletTopApp.event.home.createOrEditLabel">Create or edit a Event</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : eventEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="event-game" type="select" className="form-control" name="game.id">
                    <option value="" key="0" />
                    {games
                ...
                <AvGroup>
                  ...
                  <AvInput id="event-shop" type="select" className="form-control" name="shop.id">
                    <option value="" key="0" />
                    {shops
