...
public class Gloves implements Serializable {
    ...
    public Gloves backpacks(Set<Backpack> backpacks) {
        this.backpacks = backpacks;
        return this;
    }

    public Gloves addBackpack(Backpack backpack) {
        this.backpacks.add(backpack);
        backpack.getGloves().add(this);
        return this;
    }

    public Gloves removeBackpack(Backpack backpack) {
        this.backpacks.remove(backpack);
        backpack.getGloves().remove(this);
        return this;
    }
